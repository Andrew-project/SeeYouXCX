...
var month = now.getMonth(); //真实的月份需要再加上1
var day = now.getDate();
var currentTime = new Date();

function dealChatTime(currentItemTimeStamp, frontItemTimeStamp) {
    var ifShowTime = timeDivide(currentItemTimeStamp, frontItemTimeStamp);
...
function justSimpleDealTime(currentItemTimeStamp, ifShowTime) {
    ...
    var hoursAndMinutes = currentTime.getHours() + ':' + (currentTime.getMinutes() >= 10 ? currentTime.getMinutes() : '0' + currentTime.getMinutes());
